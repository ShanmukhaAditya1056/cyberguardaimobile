...
import { Banner, PageHeader, Spinner } from '../components/ui.jsx';
  ...
  return (
    <>
      ...
      <div className="card">
        ...
        {/* Sign-out lives here rather than in the app bar, matching the app —
            its dashboard bar carries only the alerts bell and this gear. */}
