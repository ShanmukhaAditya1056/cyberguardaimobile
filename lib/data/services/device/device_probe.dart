...
/// interface stays in front of that so the repositories can be tested on the
/// Dart VM, where no channel exists, against a probe that answers from a
/// fixture instead of from a device.
///
...
///
/// This is a normal, expected outcome rather than a bug — it is what a probe
/// returns when the host is not a device at all, such as under `flutter test`.
/// Callers surface [reason] to the user verbatim.
