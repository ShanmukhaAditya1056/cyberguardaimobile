...
///
/// Android answers through Kotlin over a platform channel. The indirection
/// through [DeviceProbe] is kept for the two cases that are not a device:
/// `flutter test` runs on the Dart VM, where the channel does not exist, and
/// [PlatformChannelService.withProbe] lets a test supply its own answers.
///
/// Calls the host cannot satisfy throw [ProbeUnsupported], whose message is
...
class PlatformChannelService {
  ...
  static DeviceProbe _probeForHost() => switch (AppPlatform.current) {
        ...
        HostPlatform.unknown => const _NullDeviceProbe(),
      };
