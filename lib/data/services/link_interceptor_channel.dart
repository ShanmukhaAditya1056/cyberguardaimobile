...
/// Interception depends on holding the system default-browser role, which is
/// something only Android lets an app take. [isSupported] reports whether the
/// role is held, the listening methods return nothing where it is false, and
/// [openInBrowser] works either way — the app has URLs to open regardless of
/// whether it ever gets to vet them first.
